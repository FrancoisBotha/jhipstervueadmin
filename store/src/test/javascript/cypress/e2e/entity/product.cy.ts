...
describe('Product e2e test', () => {
  ...
  const productSample = { title: 'violently soft unto', price: 387.37 };
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="title"]`).type('generalize colorful');
      cy.get(`[data-cy="title"]`).should('have.value', 'generalize colorful');

      cy.get(`[data-cy="price"]`).type('30396.01');
      cy.get(`[data-cy="price"]`).should('have.value', '30396.01');
