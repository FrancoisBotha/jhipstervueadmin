  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" novalidate v-on:submit.prevent="save()">
        <h2
          id="demoappApp.demoappPost.home.createOrEditLabel"
          data-cy="PostCreateUpdateHeading"
          v-text="t$('demoappApp.demoappPost.home.createOrEditLabel')"
        ></h2>
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('demoappApp.demoappPost.title')" for="post-title"></label>
            <input
              type="text"
              class="form-control"
              name="title"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('demoappApp.demoappPost.content')" for="post-content"></label>
            <textarea
              class="form-control"
              name="content"
              id="post-content"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('demoappApp.demoappPost.date')" for="post-date"></label>
            <div class="d-flex">
              <input
                id="post-date"
                data-cy="date"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="t$('demoappApp.demoappPost.blog')" for="post-blog"></label>
