...
import { type IBlog, Blog } from '@/shared/model/demoapp/blog.model';
      ...
      if (this.blog.id) {
        this.blogService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showInfo(this.t$('demoappApp.demoappBlog.updated', { param: param.id }));
          })
          .catch(error => {
            this.isSaving = false;
        ...
        this.blogService()
          ...
          .then(param => {
            this.isSaving = false;
            this.previousState();
            this.alertService.showSuccess(this.t$('demoappApp.demoappBlog.created', { param: param.id }).toString());
          })
          .catch(error => {
            this.isSaving = false;
            this.alertService.showHttpError(error.response);
