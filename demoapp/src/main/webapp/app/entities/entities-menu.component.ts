import { defineComponent, inject, onMounted, watch, type ComputedRef } from 'vue';
  ...
  setup() {
    ...
    const loadLanguage = async () => {
      if (microfrontendI18n) {
        ...
        await translationService.loadTranslations({ currentLanguage: languageToLoad, urlPrefix: 'services/demoapp/', hash: I18N_HASH });
      }
    };
